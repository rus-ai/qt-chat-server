...
def chat_bot(text):
    ...
    if bot_active is True:
        ...
        if re.search('(?i)hi|helo|hello', text):
            return random.choice(['Извините, я по английски пока не говорю!', 'Я патриот, я только русский язык знаю.', 'Увы по-английски не шпарю'])
